...
export function Hero() {
  ...
  const getHighlightedContent = () => {
    ...
    const term =
      highlightTerms[locale as keyof typeof highlightTerms] || highlightTerms.en
      ...
      <>
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="wave-animation absolute top-2/3 left-0 h-[0.58em] w-full fill-blue-300/70"
