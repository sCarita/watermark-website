...
export function Hero() {
  ...
  const getHighlightedContent = () => {
    // Map of locales to their highlight terms
    ...
    // Get the appropriate term for the current locale
    const term = highlightTerms[locale as keyof typeof highlightTerms] || highlightTerms.en
    
    // Split the title around the term
    const parts = t('hero.title').split(term)
      ...
      <>
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute top-2/3 left-0 h-[0.58em] w-full fill-blue-300/70 wave-animation"
