  ...
  return (
    ...
    >
      <label
        htmlFor="file"
        className={clsx(
          'border-primary flex min-h-[175px] w-full cursor-pointer items-center justify-center rounded-md border border-dashed p-6 transition-colors hover:border-blue-600',
          {
