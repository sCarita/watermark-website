...
>(
  (
    { selectedImage, brushSize, hasDrawing, onDrawingChange, zoomLevel },
    ref,
  ) => {
    ...
    const updateZoomLevel = (zoomLevel: number) => {
      ...
      // Convert zoomLevel to a scale factor (e.g. 100 = 1.0, 200 = 2.0, 50 = 0.5)
      const scale = zoomLevel / 100

      // Calculate new dimensions while maintaining aspect ratio
      const newWidth = baseDimensions.width * scale
      const newHeight = baseDimensions.height * scale
